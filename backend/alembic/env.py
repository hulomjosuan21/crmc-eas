...
# ---------------------------------------------------------
# 2. OVERRIDE ALEMBIC.INI URL WITH OUR SETTINGS
# ---------------------------------------------------------
# This line fixes the "driver://" error by forcing the real URL
config.set_main_option("sqlalchemy.url", settings.DATABASE_URL)

if config.config_file_name is not None:
    fileConfig(config.config_file_name)

# Set target metadata so Alembic can see your tables
